...
export default function Privacy() {
  ...
  return (
    <>
      ...
      <section className="relative bg-ink-900 pt-[150px] lg:pt-[200px] pb-24 lg:pb-32 angle-bottom overflow-hidden">
        <div className="container-custom relative">
          <div className="max-w-3xl">
            <p className="eyebrow eyebrow-light">Legal</p>
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight mb-4">Privacy Policy</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom max-w-3xl mx-auto prose prose-gray">
          <h2 className="text-2xl font-extrabold text-gray-900 mt-10 mb-3">What we collect</h2>
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-10 mb-3">What we do with it</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-10 mb-3">Who else sees it</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-10 mb-3">Cookies and tracking</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-10 mb-3">How long we keep it</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-10 mb-3">Your choices</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-10 mb-3">Children</h2>
          <p className="text-gray-700 mb-4">
            This site is not directed at children and we do not knowingly collect
            information from anyone under 13.
          </p>

          <h2 className="text-2xl font-extrabold text-gray-900 mt-10 mb-3">Changes</h2>
          <p className="text-gray-700 mb-4">
            If this policy changes, the revised version will appear on this page with a
            new date at the top.
          </p>

          <h2 className="text-2xl font-extrabold text-gray-900 mt-10 mb-3">Contact</h2>
